...
#include <functional>
#include "../questui/unity-helper.hpp"
#include "../questui/unityasset-loader.hpp"
...
public:
    ...
    bool LoadAssetBundle(UnityAssetLoader_OnLoadAssetCompleteFunction* onLoadAssetCompleteCall,bool alsoLoadAsset = false);
    // Returns true if the asset load has been requested, false otherwise
    bool LoadAsset(UnityAssetLoader_OnLoadAssetCompleteFunction* onLoadAssetCompleteCall,std::string_view assetNameS = "");
